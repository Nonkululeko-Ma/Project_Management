...
| **US-004** | | **As a Company Executive, I want to generate reports so that I can monitor project performance.** | | **The system generates PDF/CSV reports for selected projects.** | | **Medium** |
...
| **US-010** | | **As an IT Admin, I want user data encrypted with AES-256 so that security compliance is met.** | | **Data is securely stored and encrypted.** | | **High** |
